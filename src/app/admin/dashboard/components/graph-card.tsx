...
function GraphCard({ data: { title, value, image }, className }: CardProps) {
	return (
		<Card className={cn('min-h-40 w-full px-2 lg:px-3 py-4', className)}>
			...
			<div className="h-[75%] self-end grid grid-cols-2">
				<div className="space-y-3 h-full flex flex-col justify-between">
					<h2 className="flex-1 items-center flex text-xl lg:text-2xl">
						{value}
					</h2>
					<p className="text-[10px] lg:text-xs text-green-300">
						Within this year
					</p>
				</div>
