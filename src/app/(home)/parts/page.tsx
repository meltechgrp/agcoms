	...
	return (
		<div>
			...
			<div>
				...
				<section
					id="expert-service"
					className="grid sm:grid-cols-[55%,auto] gap-y-6">
				...
				<section
					...
					<ul className="grid grid-cols-2 sm:w-1/2 gap-2">
						{[
							'Filters',
							'Maintenance kits',
					...
					<div className="flex gap-4">
						<Link href={'/requests'}>
							<Button
								size="sm"
								variant={'outline'}
								className="h-12 border border-tertiary text-black px-8 sm:h-9 font-medium text-sm">
								Request a Part
							</Button>
						</Link>
						<Link href={'/contact'}>
