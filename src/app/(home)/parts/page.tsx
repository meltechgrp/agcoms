	...
	return (
		<div>
			...
			<div>
				...
				<section
					id="genuine-parts"
					className="py-15 px-4 lg:px-16 bg-[#f3f1f1] space-y-6 h-[70vh] flex flex-col justify-center">
					<h2 className="text-2xl lg:text-3xl self-start font-bold border-bottom leading-tight">
						Genuine Parts
					</h2>
					<p className="text-gray-600 lg:w-1/2 text-base lg:text-lg leading-9">
				...
				<section
					id="expert-service"
					className="grid lg:grid-cols-[55%,auto] gap-y-6">
				...
				<section
					...
					<ul className="grid grid-cols-2 lg:w-1/2 gap-2">
						{[
							'Filters',
							'Maintenance kits',
					...
					<div className="flex gap-4">
						<Link href={'/requests'}>
							<Button
								size="sm"
								variant={'outline'}
								className="h-12 border border-tertiary text-black px-8 lg:h-9 font-medium text-sm">
								Request a Part
							</Button>
						</Link>
						<Link href={'/contact'}>
				...
				<section id="order-online" className="grid lg:grid-cols-2 gap-y-6">
					<div className=" py-10 w-full px-8 lg:px-9 gap-4 flex flex-col">
						<h2 className="text-2xl lg:text-3xl self-start font-bold border-bottom leading-tight">
							Order Online
						</h2>
						<p className=" text-base lg:text-lg leading-9">
