...
function Contact({ searchParams }: Props) {
  ...
  return (
    <div className="">
      <Breadcrumb className=" py-6 px-4 lg:px-12">
        <BreadcrumbList>
          <BreadcrumbItem>
            <BreadcrumbLink
      ...
      <div className="grid lg:grid-cols-2 gap-6 py-4">
        <div className="flex flex-col  px-4 lg:px-12 space-y-4 pt-4 lg:pt-12">
          <h2 className="text-lg lg:text-2xl border-bottom self-start">
            Core Values and Code of Business Conduct
          </h2>
          <p className="text-gray-600 text-base lg:leading-7">
      ...
      <div>
        ...
        <div className="w-fit mx-auto my-6 px-4 lg:px-12 space-y-4 flex flex-col">
          <h2 className="text-lg lg:text-2xl border-bottom self-start">
