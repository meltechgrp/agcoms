...
// 	return (
// 		<Element name="specs">
// 			<div className="space-y-6 px-4 lg:px-12 py-8">
...
// 							<h2 className="text-base lg:text-lg px-2">{g.name}</h2>
// 							<div>
// 								<Table className="">
// 									<TableBody>
// 										{g.contents.map((s) => (
// 											<TableRow key={s.id} className=" even:bg-gray-100">
// 												<TableCell className="font-medium border border-border lg:w-[30%] ">
// 													{s.name}
// 												</TableCell>
